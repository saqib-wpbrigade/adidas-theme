...
<div class="hero-section">
    ...
    <img src="<?php echo get_template_directory_uri() . '/assets/img/hero-slider-leftt-arrow.png'; ?>" class="previous" />

      <img src="<?php echo get_template_directory_uri() . '/assets/img/hero-slider-right-arrow.png';?>" class="next" />
    </div>
    ...
    <div class="container">
        ...
        <div class="slider">
            <div class="hero-content">
                <h1>
                    <?php   $hero_title = get_option('slider_title');
                    echo $hero_title;
                    ?>
                </h1>
                <p>
